...
@section('content')
    ...
    <div class="container mx-auto mt-8">
        ...
        <div class="bg-gray-200 p-6 rounded-lg overflow-hidden relative">
            <img alt="Muscular Man Lifting Weights" class="absolute top-0 left-0 w-full h-full object-cover object-center opacity-70" src="https://random.imagecdn.app/1920/1080">
            <div class="relative z-10 text-white">
                ...
                <a class="inline-block bg-primary-500 text-white py-2 px-4 rounded hover:bg-primary-600 transition duration-300">
                    Ver Mais
                </a>
            </div>
        </div>
