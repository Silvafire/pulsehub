...
class PageController extends Controller
{
    ...
    public function admindashboard()
    {
       ...
       count'))->groupBy('perm')->get();
        ...
        return view('_admin.dashboard', compact('count_events','count_events_per_type', 'count_users', 'count_users_per_role','count_modalidades','count_mod_per_type','services','count_planos', 'count_planos_per_type'));
    }
}
